      ...
      >
        ...
        <div className="max-w-md mx-auto">
          ...
          <h2 className="text-3xl font-black text-darkDelegation leading-[1.2] mb-6 tracking-tight text-center">
            Vector HQ: No-code multi-agent AI command center
          </h2>

          <div className="space-y-6 text-zinc-500 text-[15px] leading-relaxed text-center sm:text-left">
            <p>
              Vector HQ is a no-code workspace where you direct a team of autonomous AI agents in a living 3D office.
            </p>
            <p>
          ...
          <div className="mt-6 flex flex-col items-center gap-6">
            ...
            <div className="pt-4 border-t border-zinc-50 w-full flex flex-col items-center">
              <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-[0.15em] text-center leading-loose">
                Developed by <a href="https://github.com/Armour007" target="_blank" rel="noopener noreferrer" className="text-zinc-600 hover:text-darkDelegation transition-colors underline decoration-zinc-100 underline-offset-4">Armour007 (Akshay Devadiga)</a>
              </p>
            </div>
          </div>
        </div>
